...
-->
 ...
 <form action="" method="post">
    ...
    $id = $_GET['izmijeni']; 
$query = "SELECT * from pocetna WHERE id = '{$id}'";
...
if(isset($_POST['btn_izmjena'])){
    ...
    $query = "UPDATE pocetna SET naslov = '{$naslov}', tekst = '{$tekst}', slika = '{$slika}' WHERE id = '{$id}' ";
...
?>
    ...
    while($red = mysqli_fetch_assoc($tabela)){
        ...
        echo "<td>$naslov</td>";
        echo "<td>$tekst</td>";
         echo "<td><img width='400' class='img-responsive' src='images/$slika'></td>";
        echo "<td><a href='index.php?obrisi=$id'>Obriši</a></td>";
         echo "<td><a href='index.php?izmijeni=$id'>Izmijeni</a></td>";
        echo "</tr>";
  }    
...
$query = "DELETE from pocetna  WHERE id = '{$id}' ";
