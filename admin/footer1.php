...
-->
    ...
    $id = $_GET['izmijeni']; 
$query = "SELECT * from footer1 WHERE id = '{$id}'";
     ...
     while($red = mysqli_fetch_assoc($tabela2)){
       $id = $red['id'];
        ...
        $meni = $red['meni'];
            ...
            ?>   
        <p>Kategorija</p>
        <input value="<?php if(isset($id)){ echo $kategorija; }?>" type="text" class="form-control" name="kategorija"><br>
        <p>Meni</p>
        <input value="<?php if(isset($id)){ echo $meni; }?>" type="text" class="form-control" name="meni"><br>
...
if(isset($_POST['btn_izmjena'])){
    ...
    $query = "UPDATE footer1 SET kategorija = '{$kategorija}', meni = '{$meni}' WHERE id = '{$id}' ";
...
?>
    ...
    while($red = mysqli_fetch_assoc($tabela)){
        ...
        echo "<td>$meni</td>";
        echo "<td><a href='footer1.php?obrisi=$id'>Obriši</a></td>";
        echo "<td><a href='footer1.php?izmijeni=$id'>Izmijeni</a></td>";
        echo "</tr>";
  }    
...
$query = "DELETE from footer1 WHERE id = '{$id}' ";
