...
-->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                     ...
                     <li class="active">
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Goallin <i class="fa fa-fw fa-caret-down"></i></a>
    ...
    while($red = mysqli_fetch_assoc($tabela)){
        ...
        echo "<td><a href='tabela.php?obrisi=$id'>Obriši</a></td>";
         echo "<td><a href='tabela.php?izmijeni=$id'>Izmijeni</a></td>";
         echo "<td><a href='tabela.php?dodaj=$id'>Dodaj</a></td>";
        echo "</tr>";
  }
...
if(isset($_POST['btn_izmjena'])){
    ...
    $query = "UPDATE goallin SET naslov1 = '{$naslov1}', naslov2 = '{$naslov2}', tekst = '{$tekst}' WHERE id = '{$id}' ";
...
//    if($naslov2 == "" || empty($naslov2)){
//        echo "Morate unijeti naslov2.";
//    }else{
        $query="Insert into goallin (naslov1, naslov2, tekst) value ('{$naslov1}', '{$naslov2}', '{$tekst}')";
        $tabela2 = mysqli_query($konekcija, $query);
        header("Location: tabela.php");
        if(!$rezultat){
            die("Greška".mysqli_error($konekcija));
